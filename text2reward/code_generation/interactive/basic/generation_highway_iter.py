...
class IterGenerator:
    ...
    def generate_code(self, environment: str,instruction:str, general_code:str, motion) -> str:
        code_content = ""
        while True:
            response = self.chain.run(**{"environment": environment,  "instruction": instruction, "general_code":general_code, "motion":motion})

...
from stable_baselines3.common.vec_env.base_vec_env import CloudpickleWrapper, VecEnv, VecEnvWrapper, VecCostWrapper
...
from stable_baselines3.common.vec_env.vec_normalize import VecNormalize, VecNormalizeWithCost
...
def sync_envs_normalization(env: VecEnv, eval_env: VecEnv) -> None:
    ...
    while isinstance(env_tmp, VecEnvWrapper):
        ...
        env_tmp = env_tmp.venv
        if isinstance(env_tmp, VecCostWrapper):
            env_tmp = env_tmp.venv
